...
<head>
    ...
    <style>
        ...
        *,
        ...
        .bg-red-50 {
            --tw-bg-opacity: 1;
            background-color: rgb(243 249 233 / var(--tw-bg-opacity))
        }
        ...
        .selection\:bg-red-500 *::selection {
            --tw-bg-opacity: 1;
            background-color: rgb(139 199 39 / var(--tw-bg-opacity))
        }
...
<body class="antialiased">
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img id="logoWelcome" src="{{ asset('favicons/favicon.png') }}" alt="Gestión de Residuos Logo"
                    class="w-100">
            </div>

            <div class="mt-6 text-center">
                <h1 class="text-xl font-semibold text-gray-900 text-center">Gestión de Residuos</h1>
                <p class="mt-6 text-gray-700 text-lg">Facilitamos la gestión de residuos a través de nuestras
                    plataformas web y móvil.</p>
            </div>

            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                <div class="p-6 bg-white rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
                    {{-- <div class="h-16 w-16 bg-green-50 flex items-center justify-center rounded-full mx-auto">
                        <i class="fa-solid fa-desktop"></i>
                    </div> --}}
                    <h2 class="mt-6 text-lg font-semibold text-gray-900 text-center">Plataforma Web</h2>
                    <p class="mt-4 text-gray-600 text-sm leading-relaxed text-center">
                        Administrada por la Municipalidad XYZ quienes se encargan de la gestión del proceso de recojo de
                        residuos manejando las unidades, rutas, zonas y programación.
                    </p>
                </div>

                <div class="p-6 bg-white rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
                    {{-- <div class="h-16 w-16 bg-blue-50 flex items-center justify-center rounded-full mx-auto">
                        <i class="fas fa-mobile-alt text-blue-500 text-3xl"></i>
                    </div> --}}
                    <h2 class="mt-6 text-lg font-semibold text-gray-900 text-center">Aplicación Móvil</h2>
                    <p class="mt-4 text-gray-600 text-sm leading-relaxed text-center">
                        Habilitada para los ciudadanos, recolectores y choferes encargadas con la finalidad de poder dar
                        a conocer cuando pasa el camión por la zona seleccionada por un ciudadano a traves del recorrido
                        de rutas realizada por los choferes y recolectores por diversas zonas.
                    </p>
                </div>
            </div>
